      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 border border-gray-700">
        ...
        <div className="flex justify-center mb-8">
          <div className="relative w-80 h-80 bg-gray-900 rounded-full border-4 border-gold-500 shadow-lg flex items-center justify-center">
            ...
            {/* Center Mecca Icon */}
            <div className="w-8 h-8 bg-gold-500 rounded-full border-4 border-gray-900 flex items-center justify-center">
              <span className="text-gray-900 text-lg">🕋</span>
            </div>

            {/* West Indicator - Mecca Icon */}
            <div 
              className="absolute w-8 h-8 bg-green-500 rounded-full border-2 border-gold-400 flex items-center justify-center shadow-lg"
              style={{
                left: '20px',
                top: '50%',
            ...
            <div className="absolute left-12 top-1/2 transform -translate-y-1/2 text-green-400 text-sm font-semibold">
              Mecca
            </div>
